...
const SpaBooking = () => {
    ...
    if (Booking.payment_status !== "active") {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-pink-50 to-purple-50">
                <div className="text-center max-w-md p-6 bg-white rounded-lg shadow-lg mx-4">
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50">
            ...
            <div className="w-full bg-gradient-to-r from-pink-500 to-purple-600 py-8 lg:py-12">
                <div className="w-full px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto text-center">
                        <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4">Service Booking</h2>
            ...
            <div className="w-full py-8 lg:py-12">
                <div className="w-full px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        {/* Status Message */}
                        {bookingStatus && (
                            <div className={`w-full mb-8 p-4 rounded-lg ${
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8">
                            ...
                            {step === 1 && (
                                <div className="space-y-6">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6 text-center">Select Services</h3>
                            ...
                            {step === 2 && (
                                <div className="space-y-6">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6 text-center">Select Date & Time</h3>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6">
                                        <button 
                                            className="px-6 py-3 bg-gray-500 text-white rounded-lg font-semibold hover:bg-gray-600 transition-all duration-300 order-2 sm:order-1"
                                            onClick={handlePrevStep}
                                        >
                                            Back: Services
                                        </button>
                                        <button 
                                            className={`px-8 py-3 rounded-lg font-semibold transition-all duration-300 order-1 sm:order-2 ${
                            ...
                            {step === 3 && (
                                <div className="space-y-6">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6 text-center">Select Staff Member</h3>
                                                ...
                                                >
                                                    <div className="flex items-center space-x-3 mb-3">
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            <h4 className="font-semibold text-gray-800 text-sm sm:text-base truncate">{staff.name}</h4>
                                                            <p className="text-sm text-gray-600 truncate">{staff.specialization}</p>
                                                        </div>
                                                    </div>
                                                    {!isAvailable && (
                            ...
                            {step === 4 && (
                                <div className="space-y-6">
                                    <h3 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-6 text-center">Your Details</h3>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6">
                                            ...
                                            <button 
                                                className="px-8 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 order-1 sm:order-2"
                                                type="submit"
                                            >
                                                Complete Booking
                                            </button>
